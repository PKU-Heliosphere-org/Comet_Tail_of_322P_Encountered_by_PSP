...
def dist_psp_particle(comet_sn_pku_local, number_of_days_comet, number_of_time_blocks_comet, beta_lst, date_tuple=(0,0,0), time_tuple=(0,0)):
    ...
    return min_dist_iblock, min_dist_ibeta, min_dist_psp_particle, psp_particle_dist_arr


def plot_dist_psp_particle(beta_lst, total_lookback_in_day, num_of_lookback, beginning_time, end_time, time_step_in_min):
    """
    ...
    for beta in beta_lst:
        ...
        sc = plt.scatter(coord_x_for_plot, coord_y_for_plot, c=total_dist_lst_for_plot, vmin=0, vmax=0.65, s=35, cmap=cm)
        plt.colorbar(sc)
        x_tick_pos_lst = [coord_x_for_plot[i] for i in range(0, num_of_time_node*(num_of_lookback + 1), 4*(num_of_lookback + 1))]
...
if __name__ == '__main__':
    plot_dist_psp_particle([0, 0.2, 0.4, 0.6, 0.8], 5, 30, "2019-08-25 00:00:00", "2019-09-10 00:00:00", 1440)
    ...
    # print(dist_psp_particle(6, 80, 320, [0.2, 0.4, 0.6], date_tuple=(2019, 9, 2), time_tuple=(0, 0)))
