...
f = open('/Users/duo/Desktop/My Files/太阳风小小组/太阳系小天体/cometels_e_less_than_1.json')
ele_data = json.load(f)
f.close()

f2 = open('/Users/duo/Desktop/My Files/太阳风小小组/太阳系小天体/modified_PSP_ephemeris_data.json')
psp_time_pos = json.load(f2)
f2.close()

f3 = open("/Users/duo/Desktop/My Files/太阳风小小组/太阳系小天体/PSP_comets_very_close_list.json")
